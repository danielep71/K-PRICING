...
| v0.0.3 — Test Hardening and Registration | Independent fixtures, durable runner and evidence schema, complete regression suites, Excel cross-oracle checks, MacroOptions registration | #38–#42 | No release |
